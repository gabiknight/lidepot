		...
		<div class="container">
			...
			*/
			if (password_verify($_POST['password'], $hash)) {	
				...
				echo "<div class='alert alert-danger mt-4' role='alert'>El email y/o la contraseña son
				incorrectos!
				<p><a href='login.html'><strong>Por favor intentá nuevamente!</strong></a></p></div>";			
			}	
			?>
		</div>
		<!-- Optional JavaScript -->
